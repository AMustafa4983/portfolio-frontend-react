...
export const exp = [
    {
        title: 'Johns Hopkins University (James Robert Brasic Lab)',
        job_title: 'AI Researcher & Data Analyst',
        description: "Created advanced data entry software for Parkinson's disease test scores, significantly reducing manual effort by 80%, and enhanced productivity by 60% through expert Excel sheet design, visualization, and thorough data analysis.",
        date: 'May 2023'
    },
    {
        title: 'Harvard University (FARIL)',
        job_title: 'Software Engineer & AI Researcher',
        description: "Utilized Convolutional Neural Networks (CNNs) to build six models (three for Ankle views and three for Foot views), achieving high accuracy in Ankle views (98% AP, 92% Lat, 92% Ob) and commendable accuracy in Foot views (86% AP, 84% Lat, 86% Ob).",
        date: 'July 2023'
    },
    {
        title: 'Conduct Science',
        job_title: 'Software Engineer',
        description: "Designed an innovative Replicates Extractor software powered by OpenAI, utilizing scientific papers to rapidly generate detailed lists of materials and suppliers, resulting in an outstanding 85% reduction in manual work effort.",
        date: 'August 2023'
    },
...
export const projects = [
    {
        ...
        skills: ['Pyton', 'Deep Learning', 'Computer Vision', 'Flask'],
    },
    {
        ...
        link: "https://github.com/AMustafa4983/FIXUS-APP",
        skills: ['Pyton', 'Deep Learning', 'NLP', 'Flask'],
    },
    {
        ...
        skills: ['Pyton', 'Open AI', 'NLP', 'Flask'],
    },
    {
        title: "Replicates-extractor",
        hint: "Replicating scientific research entails independently re-executing an experiment, adhering to original procedures, to validate or confirm initial findings.",
